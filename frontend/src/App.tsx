...
export default function App() {
  // Opt into React Router v7's `startTransition` wrapping of route state updates. This silences
  // the dev console "future flag" advisory and gets us the smoother concurrent-rendering
  // behavior ahead of the v7 upgrade. In react-router-dom 6.30, this flag lives on
  // <RouterProvider>, not on createBrowserRouter's options.
